  ...
  return (
    <div className='flex justify-center pt-[20%] pb-[35%] md:py-[10%]'>
      <div className='w-[85%] md:w-[60%] flex flex-col gap-y-[20px]'>
        ...
        <p className='text-GRAY font-Poppins font-semibold text-[22px] md:text-[30px] leading-none'>and a <span className='text-TXT'>Bug Bounty Hunter @ YesWeHack</span>.</p>
        <p className='text-GRAY font-FiraCode w-[60%]'>I've built and conceived multiple web projects both front-only and full stack applications, while responsibly researching the security of real-world web applications.</p>
