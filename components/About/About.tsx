      ...
      <div className='w-[85%] md:w-[60%] font-FiraCode flex flex-col gap-y-[20px] text-GRAY'>
        ...
        <div className='flex justify-between items-center gap-x-[5%]'>
          <div className='flex flex-col gap-y-[20px]'>
            ...
            <p>I enjoy the process of web development, from conceiving and designing websites to bringing them to life. I also practice responsible security research as a bug bounty hunter on <a className='text-TXT hover:underline' href='https://yeswehack.com/hunters/Azerojii#latest-hacktivity'>YesWeHack</a>, where I explore real-world applications and responsibly disclose vulnerabilities.</p>
            <p>My approach combines building products with breaking them thoughtfully: understand how a system works, find where its assumptions fail, and help make it stronger.</p>
